...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "atproto-auth" = rec {
        crateName = "atproto-auth";
        version = "0.1.0";
        edition = "2024";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/DzmingLi/atproto-auth.git";
          rev = "4158b4bc77159f231b3eba96adf049096afe119f";
          sha256 = "0hf4xgfrca13r03w3xfwgf9s70q924zdrqsakyyvbvc78an5r5an";
        };
        libName = "atproto_auth";
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
          ...
          }
          {
            ...
            packageId = "atproto-identity";
          }
          {
            name = "atproto-oauth";
            packageId = "atproto-oauth";
          }
          {
            name = "atproto-oauth-axum";
            packageId = "atproto-oauth-axum";
          }
          {
            name = "axum";
            packageId = "axum";
          ...
          }
          {
            name = "sqlx";
            packageId = "sqlx";
            features = [ "runtime-tokio" "postgres" "chrono" ];
          }
          {
            name = "thiserror";
      ...
      "atproto-dasl" = rec {
        crateName = "atproto-dasl";
        version = "0.14.5";
        edition = "2024";
        crateBin = [];
        sha256 = "0a2bpvsm5lr02mz5l84hyb570hpk1hvmz0si6czb52j6gxbki3d2";
        libName = "atproto_dasl";
        authors = [
          "Nick Gerakines <nick.gerakines@gmail.com>"
        ];
        dependencies = [
          {
            name = "blake3";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt" "rt-multi-thread" "io-util" "fs" "sync" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
        ...
        devDependencies = [
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt" "rt-multi-thread" "macros" "rt" "fs" ];
          }
        ];
        features = {
          "axum" = [ "dep:axum" "dep:http" "dep:bytes" ];
          "clap" = [ "dep:clap" "dep:serde_json" "dep:anyhow" ];
          "reqwest" = [ "dep:reqwest" ];
        };
        resolvedDefaultFeatures = [ "default" ];
      };
      "atproto-identity" = rec {
        crateName = "atproto-identity";
        version = "0.14.5";
        edition = "2024";
        crateBin = [];
        sha256 = "0xwf5xs30mhw3ccnfwsql8hpcdbj4zb712yxiksywm4nxsp40abj";
        libName = "atproto_identity";
        authors = [
          "Nick Gerakines <nick.gerakines@gmail.com>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "reqwest";
            usesDefaultFeatures = false;
            features = [ "charset" "http2" "system-proxy" "json" "rustls-tls" ];
          }
          {
            name = "serde";
            packageId = "serde";
        ...
        resolvedDefaultFeatures = [ "default" "hickory-dns" "lru" ];
      };
      "atproto-oauth" = rec {
        crateName = "atproto-oauth";
        version = "0.14.5";
        edition = "2024";
        crateBin = [];
        sha256 = "0jwmmaj81gzvszb3c6zgn972lfhmnl2jnfnh3mj1yzcxnls1x6wg";
        libName = "atproto_oauth";
        authors = [
          "Nick Gerakines <nick.gerakines@gmail.com>"
        ];
        dependencies = [
      ...
      "atproto-oauth-axum" = rec {
        crateName = "atproto-oauth-axum";
        version = "0.14.5";
        edition = "2024";
        crateBin = [];
        sha256 = "0am2p8rznsklimslzbbs1yq8fgcr1bgfmxwlw21lh0kp88dkb21h";
        libName = "atproto_oauth_axum";
        authors = [
          "Nick Gerakines <nick.gerakines@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "default" "hickory-dns" ];
      };
      "atproto-record" = rec {
        crateName = "atproto-record";
        version = "0.14.5";
        edition = "2024";
        crateBin = [];
        sha256 = "0n93rw0pbfaypy5qkdn0778vb92k47wj3s3q6qfdv6ham2a39a2j";
        libName = "atproto_record";
        authors = [
          "Nick Gerakines <nick.gerakines@gmail.com>"
        ];
        dependencies = [
      ...
      "axum" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "form" "http1" "json" "macros" "matched-path" "multipart" "original-uri" "query" "tokio" "tower-log" "tracing" ];
      };
      "axum-core" = rec {
        crateName = "axum-core";
        version = "0.5.6";
      ...
      "axum-extra" = rec {
        ...
        resolvedDefaultFeatures = [ "cookie" "default" "tracing" ];
      };
      "axum-macros" = rec {
      ...
      "biblatex" = rec {
        ...
        version = "0.11.0";
        edition = "2021";
        sha256 = "0rlzfa1m33mh89ygwd4igfblphz71kq1qz1a0icrl6xszrsc7l2k";
        authors = [
      ...
      "chinese-variant" = rec {
        ...
        version = "1.1.5";
        edition = "2021";
        sha256 = "0jayfnnj6766rxm5899i9rwmx9v6l2gm5bjq016mvzzz82c2mdaq";
      ...
      "citationberg" = rec {
        ...
        version = "0.6.1";
        edition = "2024";
        sha256 = "0iihjds9xsa9vqh8v9r1mnp342bvhlahva75aqgpz8xwppl9fr8z";
        authors = [
          "Martin Haug <mhaug@live.de>"
        ];
        dependencies = [
      ...
      "codex" = rec {
        ...
        version = "0.2.0";
        edition = "2021";
        sha256 = "0g22dvnqq4nkdx1bn91x0nr072qmak34b5l98yivxb2wzkpy32cm";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "styling" ];
      };
      "color_quant" = rec {
      ...
      "elliptic-curve" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "arithmetic" "default" "digest" "ecdh" "ff" "group" "hazmat" "jwk" "pem" "pkcs8" "sec1" "serde" "std" ];
      };
      ...
      "fx-atproto" = rec {
        crateName = "fx-atproto";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/fx-atproto; };
        libName = "fx_atproto";
        dependencies = [
          {
            name = "anyhow";
      ...
      "fx-client" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/fx-client; };
        libName = "fx_client";
        dependencies = [
          {
            name = "anyhow";
      ...
      "fx-core" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/fx-core; };
        libName = "fx_core";
        dependencies = [
          {
            name = "anyhow";
          ...
          }
          {
            name = "sqlx";
            packageId = "sqlx";
            features = [ "runtime-tokio" "postgres" "migrate" "chrono" "json" ];
          }
          {
            name = "thiserror";
            packageId = "thiserror 2.0.18";
          ...
          }
          {
            name = "ts-rs";
            packageId = "ts-rs";
            features = [ "chrono-impl" "serde-json-impl" ];
          }
        ];
        devDependencies = [
          {
      ...
      "fx-renderer" = rec {
        crateName = "fx-renderer";
        version = "0.1.0";
        edition = "2024";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/DzmingLi/typst-render.git";
          rev = "6a6c90ed78adc950e880d4d3116ab23721a6d958";
          sha256 = "0dsph47cm3iq9341bajkb2zq50ajq4d68kldvr5ymrssblr6hzvc";
        };
        libName = "fx_renderer";
        dependencies = [
          {
          ...
          {
            name = "markdown-it";
            packageId = "markdown-it";
          }
          {
            name = "markdown-it-footnote";
            packageId = "markdown-it-footnote";
          }
          {
            name = "markdown-it-front-matter";
            packageId = "markdown-it-front-matter";
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "fx-server" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/fx-server; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
          ...
          }
          {
            ...
            features = [ "cors" "trace" "fs" "limit" "request-id" "propagate-header" ];
          }
          {
            name = "tower_governor";
      ...
      "fx-validator" = rec {
        crateName = "fx-validator";
        version = "0.1.0";
        edition = "2024";
        crateBin = [
          {
            name = "fx-validator-knot-hook";
            path = "src/bin/knot_hook.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/fx-validator; };
        libName = "fx_validator";
        dependencies = [
          {
            name = "serde";
            packageId = "serde";
      ...
      "hayagriva" = rec {
        ...
        edition = "2024";
        crateBin = [];
        sha256 = "0xg50dmf1xva3imph33r594n22j4pby2fvnandrl263gfcjr9dhw";
        authors = [
          "Martin Haug <mhaug@live.de>"
        ];
        dependencies = [
      ...
      "hayro" = rec {
        ...
        version = "0.4.0";
        edition = "2024";
        sha256 = "0q1fydqia5dr3dm1hrr1m78nbvav9p302h3y5bxv0asmi2x8i104";
        dependencies = [
          {
            name = "bytemuck";
            packageId = "bytemuck";
          ...
          {
            name = "kurbo";
            packageId = "kurbo 0.12.0";
          }
        ];
        features = {
          "default" = [ "embed-fonts" ];
          "embed-fonts" = [ "hayro-interpret/embed-fonts" ];
          "jpeg2000" = [ "hayro-interpret/jpeg2000" ];
        };
      };
      "hayro-font" = rec {
        crateName = "hayro-font";
        version = "0.3.0";
        edition = "2024";
        sha256 = "0qw44j2f8b4si4dllymkcrmi0qdscpn41qh1g47ag9j0x1yfkrqh";
        libName = "hayro_font";
        authors = [
      ...
      "hayro-interpret" = rec {
        ...
        version = "0.4.0";
        edition = "2024";
        sha256 = "00h1yzwc8z33yka4d6v9fvjldy39wx5y3c8kvgrl9s085nblq82n";
        ...
        dependencies = [
          ...
          {
            name = "yoke";
            packageId = "yoke 0.8.2";
            features = [ "derive" ];
          }
        ];
        features = {
          "default" = [ "embed-fonts" ];
          "jpeg2000" = [ "hayro-syntax/jpeg2000" ];
        };
      };
      "hayro-svg" = rec {
        crateName = "hayro-svg";
        version = "0.2.0";
        edition = "2024";
        sha256 = "1iaaphm88czrsdi9n9vhmacnhr25rp7gqwag7gyhsvpc9hq77ip8";
        libName = "hayro_svg";
        authors = [
          "Laurenz Stampfl <laurenz.stampfl@gmail.com>"
        ];
      ...
      "hayro-syntax" = rec {
        ...
        version = "0.4.0";
        edition = "2024";
        sha256 = "1ghh9nqif7gpwmzxv2321fwkflaz1z06q6jxfx1dq48gpiymr7iz";
      ...
      "hypher" = rec {
        ...
        features = {
          "default" = [ "alloc" "full" ];
          "full" = [ "afrikaans" "albanian" "assamese" "bengali" "belarusian" "bulgarian" "catalan" "croatian" "czech" "danish" "dutch" "english" "estonian" "finnish" "french" "galician" "georgian" "german" "greek" "gujarati" "hindi" "hungarian" "icelandic" "italian" "kannada" "kurmanji" "latin" "lithuanian" "malayalam" "marathi" "mongolian" "norwegian" "oriya" "panjabi" "polish" "portuguese" "russian" "sanskrit" "serbian" "slovak" "slovenian" "spanish" "swedish" "tamil" "telugu" "turkish" "turkmen" "ukrainian" ];
        };
        resolvedDefaultFeatures = [ "afrikaans" "albanian" "alloc" "assamese" "belarusian" "bengali" "bulgarian" "catalan" "croatian" "czech" "danish" "default" "dutch" "english" "estonian" "finnish" "french" "full" "galician" "georgian" "german" "greek" "gujarati" "hindi" "hungarian" "icelandic" "italian" "kannada" "kurmanji" "latin" "lithuanian" "malayalam" "marathi" "mongolian" "norwegian" "oriya" "panjabi" "polish" "portuguese" "russian" "sanskrit" "serbian" "slovak" "slovenian" "spanish" "swedish" "tamil" "telugu" "turkish" "turkmen" "ukrainian" ];
      };
      "iana-time-zone" = rec {
        ...
        dependencies = [
          {
            ...
            packageId = "icu_collections 2.2.0";
            usesDefaultFeatures = false;
          }
          {
          ...
          {
            name = "icu_properties";
            packageId = "icu_properties 2.2.0";
            optional = true;
            usesDefaultFeatures = false;
          }
          {
            name = "icu_provider";
            packageId = "icu_provider 2.2.0";
            usesDefaultFeatures = false;
          }
          {
            name = "smallvec";
      ...
      "icu_properties 1.5.1" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "icu_properties_data 1.5.1";
            optional = true;
            usesDefaultFeatures = false;
          }
          {
      ...
      "icu_properties 2.2.0" = rec {
        ...
        dependencies = [
          ...
          {
            name = "icu_properties_data";
            packageId = "icu_properties_data 2.2.0";
            optional = true;
            usesDefaultFeatures = false;
          }
          {
      ...
      "k256" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "arithmetic" "default" "digest" "ecdsa" "ecdsa-core" "jwk" "once_cell" "pkcs8" "precomputed-tables" "schnorr" "sha2" "sha256" "signature" "std" ];
      };
      "kamadak-exif" = rec {
      ...
      "kurbo 0.12.0" = rec {
        ...
        version = "0.12.0";
        edition = "2021";
        sha256 = "0cjyh94d279d17n9095c4si3nxjif4pgsdmp7898d3f17362k5yf";
        authors = [
          "Raph Levien <raph.levien@gmail.com>"
        ];
        dependencies = [
      ...
      "latex2mathml" = rec {
        ...
        version = "0.2.3";
        edition = "2018";
        sha256 = "0r87f6g315hz3j0dv95gl0nivjiqcpiyxjg0wrja4qxsnfyzb337";
        authors = [
      ...
      "markdown-it" = rec {
        crateName = "markdown-it";
        version = "0.6.1";
        edition = "2021";
        crateBin = [];
        sha256 = "1b2gz0rikqlryb8rqc6b2xgs259fg8k582clq0npn8f8544h377r";
        libName = "markdown_it";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "linkify" "syntect" ];
      };
      "markdown-it-footnote" = rec {
        crateName = "markdown-it-footnote";
        version = "0.2.0";
        edition = "2021";
        sha256 = "1gp3mawnnpjqf2lhihpfby1gcssmyxx4gyr51clmpi7vcywrlrz6";
        libName = "markdown_it_footnote";
        authors = [
      ...
      "markdown-it-front-matter" = rec {
        crateName = "markdown-it-front-matter";
        version = "0.3.0";
        edition = "2021";
        sha256 = "01aj9y769xiij7b83rx2jg5gf4cxhzjg6y2h2x01xqj1xxnxg0ai";
        libName = "markdown_it_front_matter";
        authors = [
          "Chris Sewell <chrisj_sewell@hotmail.com>"
        ];
        dependencies = [
      ...
      "mdurl" = rec {
        ...
        version = "0.3.1";
        edition = "2021";
        sha256 = "1lphpz6yc5151w23m5zcp8c8ll2yx26gi5x8k767r3xcpd2vldjp";
        authors = [
          "Alex Kocharin <alex@kocharin.ru>"
        ];
        dependencies = [
      ...
      "nightboat-cli" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/nightboat-cli; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
      ...
      "open" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1z9pbnc0lx1lqx1p74szfar7rv21shcggkjzyymmga19giqsnfwz";
        authors = [
      ...
      "p256" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "arithmetic" "default" "digest" "ecdsa" "ecdsa-core" "jwk" "pem" "pkcs8" "serde" "serdect" "sha2" "sha256" "std" ];
      };
      "p384" = rec {
        crateName = "p384";
        version = "0.13.1";
        ...
        resolvedDefaultFeatures = [ "alloc" "arithmetic" "default" "digest" "ecdh" "ecdsa" "ecdsa-core" "jwk" "pem" "pkcs8" "serde" "serdect" "sha2" "sha384" "std" ];
      };
      "palette" = rec {
        crateName = "palette";
        version = "0.7.6";
      ...
      "readonly" = rec {
        ...
        version = "0.2.13";
        edition = "2021";
        sha256 = "0qnh2f66myxhchyav9gzg05hdi84i0nd8jslvh2m7jl1xn2jv9pj";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "charset" "default" "default-tls" "h2" "http2" "json" "multipart" "rustls-tls" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" "system-proxy" ];
      };
      "reqwest-chain" = rec {
        crateName = "reqwest-chain";
        version = "1.0.0";
        edition = "2021";
        sha256 = "1cp25ryyxmx3b5fabz5pa0jhsx87h5s3shx08kdjg0lsnx7h2p6s";
        libName = "reqwest_chain";
        authors = [
      ...
      "reqwest-middleware" = rec {
        ...
        resolvedDefaultFeatures = [ "json" "multipart" ];
      };
      "resolv-conf" = rec {
      ...
      "syntect" = rec {
        ...
        resolvedDefaultFeatures = [ "bincode" "default-fancy" "default-syntaxes" "default-themes" "dump-create" "dump-load" "fancy-regex" "flate2" "fnv" "html" "parsing" "plist" "plist-load" "regex-fancy" "regex-syntax" "yaml-load" "yaml-rust" ];
      };
      ...
      "tinystr 0.7.6" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "serde" "zerovec" ];
      };
      "tinystr 0.8.3" = rec {
        crateName = "tinystr";
        version = "0.8.3";
      ...
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "cors" "default" "follow-redirect" "fs" "futures-core" "futures-util" "httpdate" "iri-string" "limit" "mime" "mime_guess" "percent-encoding" "propagate-header" "request-id" "set-status" "tokio" "tokio-util" "tower" "trace" "tracing" "uuid" ];
      };
      "tower-layer" = rec {
      ...
      "tower_governor" = rec {
        ...
        version = "0.8.0";
        edition = "2021";
        sha256 = "1rkgffvfgnf9n7r9vcv76d0fcbcc80nxg0x80rpc9ls9v2a9ppj4";
        authors = [
        ...
        resolvedDefaultFeatures = [ "axum" "default" "tonic" ];
      };
      "tracing" = rec {
        crateName = "tracing";
        version = "0.1.44";
      ...
      "ts-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "chrono-impl" "default" "serde-compat" "serde-json-impl" "serde_json" ];
      };
      "ts-rs-macros" = rec {
      ...
      "typst" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "0lq676x98w2cc04bkhprp2ndp5ix128kildl4brz8xl4b7p12r8z";
        authors = [
          "The Typst Project Developers"
        ];
        dependencies = [
      ...
      "typst-assets" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "0kw35ja5ikrir67npwmzhz0pwxh7s4jkcz02fjdzw8k2k9qwn4sn";
      ...
      "typst-eval" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "09i5ysbmbilsv2m4yc1y1kkn90x2yx605ma42fa1w37wgm45fxv8";
        libName = "typst_eval";
        authors = [
          "The Typst Project Developers"
        ];
      ...
      "typst-html" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "1bcara30nc2qsnk261n57k6br88biclf1hf3743wkm34z6j8v7z2";
        libName = "typst_html";
        authors = [
          "The Typst Project Developers"
        ];
      ...
      "typst-layout" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "14c47cg98a5d35yx2bkjq6r8ris1c47qlwb3iqasjcaq20005asc";
        ...
        dependencies = [
          ...
          {
            name = "icu_properties";
            packageId = "icu_properties 1.5.1";
            features = [ "serde" ];
          }
          {
            name = "icu_provider";
      ...
      "typst-library" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "06wx7phgngb67q31ib5mh12flm1f4lvc47hiwbpl6302aggaaxp2";
      ...
      "typst-macros" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "0n9szl1yhrbxfr3qzk48fgybxxsd4qmga4qhv9mvz7qj4w8bs70l";
        procMacro = true;
      ...
      "typst-realize" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "1n1riysmhwkka0sqygk4r2a0ynz89sks52lpk0p3vfbzfmjfkzzp";
      ...
      "typst-svg" = rec {
        ...
        version = "0.14.2";
        edition = "2024";
        sha256 = "17fwrk179ws3hv125b0f151n85kdn0zvzn7h7qjg1qdd6wc82sz4";
        libName = "typst_svg";
        authors = [
          "The Typst Project Developers"
        ];
      ...
      "unic-langid" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "macros" "serde" "unic-langid-macros" ];
      };
      ...
      "usvg" = rec {
        ...
        resolvedDefaultFeatures = [ "fontdb" "rustybuzz" "text" "unicode-bidi" "unicode-script" "unicode-vo" ];
      };
      "utf8-width" = rec {
      ...
      "wasmi" = rec {
        ...
        version = "0.51.5";
        edition = "2021";
        sha256 = "1zr381vdjj8r77w8nyr50am1i68x7phhiaapfs178hjrrq1i8cmv";
        authors = [
        ...
        features = {
          ...
          "std" = [ "wasmi_core/std" "wasmi_collections/std" "wasmparser/std" "spin/std" ];
          "wat" = [ "dep:wat" "std" ];
        };
      ...
      "wasmi_collections" = rec {
        ...
        version = "0.51.5";
        edition = "2021";
        sha256 = "0wlifks0r4aqh7jha9h7g0q9mjzirdjyf9c2kx4399d28n7fkf79";
        authors = [
          "Robin Freyler <robin.freyler@gmail.com>"
        ];
        features = {
      ...
      "wasmi_core" = rec {
        ...
        version = "0.51.5";
        edition = "2021";
        sha256 = "1rhjhmp1kwzxcx8aaiy715prdm0l3zv35x87mc78256z1if3fpy2";
        authors = [
          "Robin Freyler <robin.freyler@gmail.com>"
        ];
        dependencies = [
      ...
      "wasmi_ir" = rec {
        ...
        version = "0.51.5";
        edition = "2021";
        sha256 = "1nf36g5s5298acswwsxsxnrz775jjj1vcq22as7wngi9lil2lkk2";
        authors = [
          "Robin Freyler <robin.freyler@gmail.com>"
        ];
        dependencies = [
      ...
      "wasmparser 0.228.0" = rec {
        crateName = "wasmparser";
        version = "0.228.0";
        edition = "2021";
        sha256 = "1qwa34ia97p8hn5rc3w76vrp0320a8hva6xwdgalgxzxq4r13gsa";
        authors = [
        ...
        resolvedDefaultFeatures = [ "features" "simd" "validate" ];
      };
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "knownfolders" "objbase" "profileapi" "shlobj" "winbase" "winerror" ];
      };
      ...
      "xtask" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/xtask; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
      ...
      "zerovec 0.11.6" = rec {
        ...
        dependencies = [
          ...
          {
            name = "zerovec-derive";
            packageId = "zerovec-derive 0.11.3";
            optional = true;
            usesDefaultFeatures = false;
          }
        ];
