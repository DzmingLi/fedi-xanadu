...
> This lecture is part of [The Missing Semester of Your CS Education](https://missing.csail.mit.edu/2020/command-line/), MIT. Licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).

<iframe width="560" height="315" src="https://www.youtube.com/embed/e8BO_dYxk5c" frameborder="0" allowfullscreen></iframe>
...
**Local Port Forwarding** ![Local Port Forwarding](/static/media/images/local-port-forwarding.png)

**Remote Port Forwarding** ![Remote Port Forwarding](/static/media/images/remote-port-forwarding.png)
