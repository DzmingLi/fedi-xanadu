 ...
 */
export type CategoryMetadata = { "type": "paper" } & CreatePaperMetadata | { "type": "review", book_id: string | null, edition_id: string | null, course_id: string | null, } | { "type": "experience" } & CreateExperienceMetadata;
