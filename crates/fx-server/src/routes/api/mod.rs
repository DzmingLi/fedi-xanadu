...
fn tag_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/tags/{id}/name-pref", put(tags::set_user_name_pref).delete(tags::clear_user_name_pref))
        .route("/tags/{id}/history", get(tags::get_tag_history))
...
fn admin_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/admin/series/merge", post(admin::admin_merge_series))
...
fn book_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/books/{id}/rate", post(books::rate_book).delete(books::unrate_book))
