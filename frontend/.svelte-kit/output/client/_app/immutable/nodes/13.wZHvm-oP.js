...
~~删除线~~</code></pre> <h3 class="svelte-vpxp7s">图片</h3> <pre class="svelte-vpxp7s"><code class="svelte-vpxp7s">![描述](filename.png)</code></pre></section> <section><h2 class="svelte-vpxp7s">LaTeX</h2> <p class="svelte-vpxp7s">适合已有 LaTeX 文档或习惯 LaTeX 语法的用户。通过 pandoc 转换为 HTML，数学渲染为 MathML。</p> <h3 class="svelte-vpxp7s">基本用法</h3> <p class="svelte-vpxp7s">不需要 <code class="svelte-vpxp7s">\\documentclass</code> 和 <code class="svelte-vpxp7s">\\begin&lbrace;document&rbrace;</code>，直接写正文内容：</p> <pre class="svelte-vpxp7s"><code class="svelte-vpxp7s">\\section&lbrace;引言&rbrace;
