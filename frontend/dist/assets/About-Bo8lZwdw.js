import{p as i,k as e,l as r,v as d}from"./index-DN1-QIKe.js";import"./legacy-DMUg0ZEu.js";import{h as p}from"./html-z6lGSv_W.js";import{g as s,i as u}from"./marked.esm-C2bYYmb6.js";const h=`# Fedi-Xanadu：让知识流向对的人
...
Fedi-Xanadu 提供完整的命令行工具（\`fx\`），支持文章发布、系列管理、用户管理等全部操作。这意味着 AI agent 可以无缝地替你创作、编辑和发布内容——不需要模拟浏览器操作，不需要处理复杂的 UI 交互，直接调用 CLI 即可。
...
`;var k=d('<div class="content svelte-8kinj7"></div>');function T(a,t){i(t,!1);const o=s.parse(h);u();var n=k();p(n,()=>o,!0),e(a,n),r()}export{T as default};
