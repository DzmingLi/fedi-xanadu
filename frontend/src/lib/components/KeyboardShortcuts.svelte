<script lang="ts">
  ...
  function executeAction(actionId: string) {
    switch (actionId) {
      case 'goto.home': goto('/'); break;
      case 'goto.skills': goto('/skills'); break;
      case 'goto.library': goto('/library'); break;
      case 'goto.about': goto('/about'); break;
      case 'goto.newArticle': goto('/new'); break;
      case 'goto.newSeries': goto('/new-series'); break;
      case 'search':
