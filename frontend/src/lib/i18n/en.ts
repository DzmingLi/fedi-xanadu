export default {
  ...
  'books.editAction.chapterCreate': 'TOC +',
  'books.editAction.chapterUpdate': 'TOC ~',
  'books.editAction.chapterDelete': 'TOC −',
  'books.examTagsLabel': 'Exam prep',
  'books.examFilterLabel': 'Exam:',
  'books.examFilter.all': 'All',
  'books.examFilter.anyExam': 'Any exam',
  'books.examTag.kaoyan-math-1': 'Kaoyan Math I',
  'books.examTag.kaoyan-math-2': 'Kaoyan Math II',
  'books.examTag.kaoyan-math-3': 'Kaoyan Math III',
  'books.examTag.kaoyan-math-agri': 'Kaoyan Math (Agriculture)',
  'books.examTag.kaoyan-408': 'Kaoyan 408 (CS)',
  'books.examTag.kaoyan-english-1': 'Kaoyan English I',
  'books.examTag.kaoyan-english-2': 'Kaoyan English II',
  'books.examTag.kaoyan-politics': 'Kaoyan Politics',
  ...
  'term.discussion': 'Discussion',
  'term.topic': 'Topic',
  'term.readings': 'Readings',
  'term.video': 'Video',
  'term.hw': 'HW',
  'term.learnerNotes': 'Notes',
  'term.writeNote': 'Write a note',
  'term.noNotes': 'No notes yet.',
  'term.onLecture': 'Lecture',
  'term.syllabus': 'Syllabus',
  'term.textbooks': 'Textbooks',
  'term.recommendedReading': 'Recommended reading',
  'term.staff': 'Staff',
  'term.prerequisites': 'Prerequisites',
  'term.skillTrees': 'Skill Trees',
  'term.materials': 'Materials',
  'term.supplementary': 'Supplementary',
  'term.notes': 'Notes',
  'term.slides': 'Slides',
  'term.recitation': 'Recitation',
  ...
  'term.source': 'Source',
  'term.addTagPlaceholder': 'Add a tag (name or tag-id)',
  'term.removeTag': 'Remove this tag',
  'term.license': 'License',
  'term.otherIterations': 'Other iterations',
  'term.language': 'Language',
  'term.myRating': 'My rating',
  'term.clearRating': 'Clear rating',
  'term.status.wantToLearn': 'Want to learn',
  'term.status.learning': 'Learning',
  'term.status.finished': 'Finished',
  'term.status.dropped': 'Dropped',
  'term.progress': 'Progress',
  'term.sessionsDone': 'lectures done',
  'term.markDone': 'Mark as learned',
  'term.markUndone': 'Mark as unlearned',
  'term.addSession': '+ Add session',
  'term.editSession': 'Edit session',
  'term.newSession': 'New session',
  'term.sessionDate': 'Date',
  'term.sessionOrder': 'Order',
  'term.deleteSessionConfirm': 'Delete this session?',
  'term.reviews': 'Reviews',
  'term.writeReview': 'Write a review',
  'term.noReviews': 'No reviews yet.',
  'term.qa': 'Q&A',
  'term.askQuestion': 'Start a discussion',
  'term.titlePlaceholder': 'Title (optional)',
  'term.bodyPlaceholder': 'Ask a question or share your thoughts...',
  'term.post': 'Post',
  'term.reply': 'Reply',
  'term.showReplies': 'Show replies',
  'term.hideReplies': 'Hide replies',
