export default {
  ...
  'events.kind.conference': 'Conference',
  ...
  'events.kindLabel': 'Event type',
  'events.organizerLabel': 'Organizer',
  'events.locationLabel': 'Location (leave empty for online)',
  'events.onlineUrlLabel': 'Online URL',
  'events.startTime': 'Start time',
  'events.endTime': 'End time (optional)',
  'events.maxAttendeesLabel': 'Max attendees (optional)',
  'events.contactEmail': 'Contact email',
  'events.contactUrl': 'Contact URL',
  'events.descPlaceholder': 'Describe the event, agenda, etc.',
  'events.teaches': 'Tags',
  'events.prereqs': 'Prerequisites',
  'events.creating': 'Creating...',
  'events.publishing': 'Publishing...',
  'events.deleteConfirm': 'Delete this event?',
  'events.full': 'Full',
  'events.rsvpCount': '{0} attending',
