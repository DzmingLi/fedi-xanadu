export default {
  ...
  'courses.subtitle': 'Browse and create course syllabi',
  'courses.create': 'Create Course',
  'courses.empty': 'No courses yet',
  'courses.units': 'Units',
  'courses.items': 'Items',
  'courses.addUnit': 'Add Unit',
  'courses.addItem': 'Add Item',
  'courses.unitTitle': 'Unit Title',
  'courses.itemTitle': 'Item Title',
  'courses.description': 'Course Description',
  'courses.scheduleType': 'Schedule Type',
  'courses.weekly': 'Weekly',
  'courses.module': 'By Module',
  'courses.custom': 'Custom',
  'courses.availableFrom': 'Available From',
  'courses.dueDate': 'Due Date',
  'courses.role.reading': 'Reading',
  'courses.role.video': 'Video',
  'courses.role.assignment': 'Assignment',
  'courses.role.supplement': 'Supplement',
  'courses.role.lecture': 'Lecture',
  'courses.instructor': 'Instructor',
  'courses.coverUrl': 'Cover URL',
  'courses.externalUrl': 'External URL',
  'courses.targetUri': 'Internal Content URI',
  'courses.note': 'Note',
  'courses.noUnits': 'No units yet. Click "Add Unit" to start building the course.',
