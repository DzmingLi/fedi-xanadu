export default {
  ...
  'newSeries.descPlaceholder': 'Brève description de la série',
  ...
  'nav.courses': 'Cours',
  'courses.title': 'Cours',
  'courses.subtitle': 'Parcourir et créer des plans de cours',
  'courses.create': 'Créer un cours',
  'courses.empty': 'Aucun cours',
  'courses.units': 'Unités',
  'courses.items': 'Contenus',
  'courses.addUnit': 'Ajouter une unité',
  'courses.addItem': 'Ajouter un contenu',
  'courses.unitTitle': "Titre de l'unité",
  'courses.itemTitle': 'Titre du contenu',
  'courses.description': 'Description du cours',
  'courses.scheduleType': 'Type de planning',
  'courses.weekly': 'Hebdomadaire',
  'courses.module': 'Par module',
  'courses.custom': 'Personnalisé',
  'courses.availableFrom': 'Disponible à partir de',
  'courses.dueDate': 'Date limite',
  'courses.role.reading': 'Lecture',
  'courses.role.video': 'Vidéo',
  'courses.role.assignment': 'Devoir',
  'courses.role.supplement': 'Supplément',
  'courses.role.lecture': 'Cours magistral',
  'courses.instructor': 'Enseignant',
  'courses.coverUrl': 'URL de couverture',
  'courses.externalUrl': 'URL externe',
  'courses.targetUri': 'URI de contenu interne',
  'courses.note': 'Note',
  'courses.noUnits': 'Aucune unité. Cliquez sur "Ajouter une unité" pour commencer.',
  'courses.confirmDeleteUnit': "Supprimer cette unité ? Tous les contenus seront supprimés.",
  'courses.confirmDeleteItem': 'Supprimer ce contenu ?',
  'courses.confirmDeleteCourse': 'Supprimer ce cours ? Toutes les unités et contenus seront supprimés.',
  'courses.term': 'Semestre',
  'courses.year': 'Année',
  'courses.newOffering': 'Nouvelle session',
  'courses.otherOfferings': 'Autres sessions',
  'courses.current': 'Actuel',
