export default {
  ...
  'events.cancelRsvp': 'Annuler RSVP',
  'events.attendees': 'Participants',
  'events.online': 'En ligne',
  'events.cancelled': 'Annulé',
  'events.maxAttendees': 'Participants max',
  'events.organizer': 'Organisateur',
  'events.location': 'Lieu',
  'events.time': 'Horaire',
  'events.contact': 'Contact',
  'events.description': 'Description',
  'events.kind.conference': 'Conférence',
  'events.kind.workshop': 'Atelier',
  'events.kind.seminar': 'Séminaire',
  'events.kind.meetup': 'Rencontre',
  'events.kind.hackathon': 'Hackathon',
  'events.titleLabel': 'Titre de l\'événement',
  'events.kindLabel': 'Type d\'événement',
  'events.organizerLabel': 'Organisateur',
  'events.locationLabel': 'Lieu (laisser vide pour en ligne)',
  'events.onlineUrlLabel': 'Lien en ligne',
  'events.startTime': 'Heure de début',
  'events.endTime': 'Heure de fin (optionnel)',
  'events.maxAttendeesLabel': 'Participants max (optionnel)',
  'events.contactEmail': 'Email de contact',
  'events.contactUrl': 'Lien de contact',
  'events.descPlaceholder': 'Décrivez l\'événement, le programme, etc.',
  'events.teaches': 'Tags',
  'events.prereqs': 'Prérequis',
  'events.creating': 'Création...',
  'events.publishing': 'Publication...',
  'events.deleteConfirm': 'Supprimer cet événement ?',
  'events.full': 'Complet',
  'events.rsvpCount': '{0} participant(s)',
