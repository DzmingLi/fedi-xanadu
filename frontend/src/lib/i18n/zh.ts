export default {
  ...
  'nav.courses': '课程',
  'courses.title': '课程',
  'courses.subtitle': '浏览和创建课程大纲',
  'courses.create': '创建课程',
  'courses.empty': '暂无课程',
  'courses.units': '单元',
  'courses.items': '内容',
  'courses.addUnit': '添加单元',
  'courses.addItem': '添加内容',
  'courses.unitTitle': '单元标题',
  'courses.itemTitle': '内容标题',
  'courses.description': '课程描述',
  'courses.scheduleType': '排课方式',
  'courses.weekly': '按周',
  'courses.module': '按模块',
  'courses.custom': '自定义',
  'courses.availableFrom': '可用日期',
  'courses.dueDate': '截止日期',
  'courses.role.reading': '阅读',
  'courses.role.video': '视频',
  'courses.role.assignment': '作业',
  'courses.role.supplement': '补充',
  'courses.role.lecture': '讲课',
  'courses.instructor': '讲师',
  'courses.coverUrl': '封面链接',
  'courses.externalUrl': '外部链接',
  'courses.targetUri': '站内内容URI',
  'courses.note': '备注',
  'courses.noUnits': '暂无单元，点击"添加单元"开始构建课程',
