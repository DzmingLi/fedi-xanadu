export default {
  ...
  'course.status.wantToLearn': '想学',
  'course.status.learning': '在学',
  'course.status.finished': '学完',
  'course.status.dropped': '不学了',
  'course.progress': '进度',
  'course.sessionsDone': '节已学',
  'course.markDone': '标为已学',
  'course.markUndone': '标为未学',
  'course.addSession': '+ 添加课节',
  'course.editSession': '编辑课节',
  'course.newSession': '新建课节',
  'course.sessionDate': '日期',
  'course.sessionOrder': '序号',
  'course.deleteSessionConfirm': '确定删除此课节？',
  'course.reviews': '课程评价',
  'course.writeReview': '写评价',
  'course.noReviews': '暂无评价。',
  'course.qa': '问答讨论',
  'course.askQuestion': '发起讨论',
  'course.titlePlaceholder': '标题（选填）',
  'course.bodyPlaceholder': '说说你的问题或想法...',
  'course.post': '发布',
  'course.reply': '回复',
  'course.showReplies': '查看回复',
  'course.hideReplies': '收起回复',
