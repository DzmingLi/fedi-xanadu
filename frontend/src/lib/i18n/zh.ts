export default {
  ...
  'events.rsvp': '报名',
  'events.going': '参加',
  'events.interested': '感兴趣',
  'events.cancelRsvp': '取消报名',
  'events.attendees': '参加者',
  'events.online': '线上',
  'events.cancelled': '已取消',
  'events.maxAttendees': '人数上限',
  'events.organizer': '主办方',
  'events.location': '地点',
  'events.time': '时间',
  'events.contact': '联系方式',
  'events.description': '活动描述',
  'events.kind.conference': '学术会议',
  'events.kind.workshop': '工作坊',
  'events.kind.seminar': '研讨会',
  'events.kind.meetup': '见面会',
  'events.kind.hackathon': '黑客松',
  'events.titleLabel': '活动名称',
  'events.kindLabel': '活动类型',
  'events.organizerLabel': '主办方',
  'events.locationLabel': '地点（留空则为线上）',
  'events.onlineUrlLabel': '线上链接',
  'events.startTime': '开始时间',
  'events.endTime': '结束时间（可选）',
  'events.maxAttendeesLabel': '人数上限（可选）',
  'events.contactEmail': '联系邮箱',
  'events.contactUrl': '联系链接',
  'events.descPlaceholder': '描述活动内容、议程等',
  'events.teaches': '相关标签',
  'events.prereqs': '前置知识',
  'events.creating': '创建中...',
  'events.publishing': '发布中...',
  'events.deleteConfirm': '确定要删除此活动吗？',
  'events.full': '已满',
  'events.rsvpCount': '{0} 人报名',
